...
const Login = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gray-900 bg-opacity-50 bg-no-repeat bg-cover bg-center"
      style={{
              ...
              <div className="flex items-center justify-center">
                ...
                >
                  ...
                  <path
                    ...
                    fill="currentColor"
                    d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4zm12-4a8 8 0 01-8 8v-4a4 4 0 014-4h4z"
                  ></path>
                </svg>
